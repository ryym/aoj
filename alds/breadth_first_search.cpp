...
// 頂点 start_v から各頂点への最短距離を paths に格納する。
void minimum_paths(int n_v, vector<int> graph[], int start_v, int paths[]) {
    queue<int> visits;
    int found[n_v];
...
int main() {
    ...
    minimum_paths(n_v, graph, 0, paths);
